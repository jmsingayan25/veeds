<?php
	...
	$_POST['user_id'] = "182";
	$_POST['uploader_user_id'] = "183";

	if(isset($_POST['user_id']) && isset($_POST['uploader_user_id'])){

		$search['select'] = "a.video_id, a.video_name, a.description, a.video_thumb, a.video_file, a.date_upload, a.view_count, c.place_name, a.location, a.coordinates, a.user_id AS uploader_user_id, a.landscape_file, b.user_id, a.place_id";
