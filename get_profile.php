<?php
	...
	if(isset($_POST['user_id'])){
		...
		if(($list['private'] == 1 && $list['followed'] == 0 && $_POST['logged_id'] != $row2['user_id']) || ($list['private'] == 1 && $list['followed'] == 1 && $_POST['logged_id'] != $row2['user_id']) || ($list['private'] == 0) || ($_POST['logged_id'] == $row2['user_id'])){
