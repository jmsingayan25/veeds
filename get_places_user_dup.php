<?php
	...
	if(isset($_POST['place_id'])){
		...
		$search2['select'] = "DISTINCT u.user_id, u.firstname, u.lastname, u.email, u.bday, u.gender, u.username, u.profile_pic, u.cover_photo, u.country, u.private, COUNT(DISTINCT DATE_FORMAT(h.date_visit,'%m-%d-%y')) as visit_count, h.place_id";
