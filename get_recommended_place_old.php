<?php
	...
	if(isset($_POST['user_id'])){
    	...
    	$search['where'] = "user_id = ".$_POST['user_id']." AND user_id_follow != '".$_POST['user_id']."' AND approved = 1";
		...
		$search3['where'] = "u.user_id = v.user_id AND v.coordinates = e.coordinates AND e.location_id IN (".$location_id.")
